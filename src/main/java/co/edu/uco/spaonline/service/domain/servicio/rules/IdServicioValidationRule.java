...
public class IdServicioValidationRule implements  ValidationRule <UUID>{
	
	private static final ValidationRule<UUID> instancia = new IdServicioValidationRule();
	
	private IdServicioValidationRule() {
		super();
	}
