...
public class PrecioValidationRule implements ValidationRule<Integer> {
	
	private static final ValidationRule<Integer> instancia = new PrecioValidationRule();

	private PrecioValidationRule() {
		super();
	}
