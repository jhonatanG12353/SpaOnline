...
public class NombreCompletoClienteEntityMapper implements EntityMapper<NombreCompletoClienteEntity, NombreCompletoClienteDomain>{
	...
	public NombreCompletoClienteEntity toEntity(NombreCompletoClienteDomain domain) {
		...
		return NombreCompletoClienteEntity.crear (domain.getPrimerNombre(), domain.getSegundoNombre(),
				domain.getPrimerApellido(), domain.getSegundoApellido());
	}
		public static final NombreCompletoClienteDomain
		convertToDomain(final NombreCompletoClienteEntity entity) {
			return instancia.toDomain(entity);
		}
		public static final NombreCompletoClienteEntity
		convertToEntity(final NombreCompletoClienteDomain domain) {
